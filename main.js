...
case 'play2doc': {
    ...
    if (!text) {
        await sock.sendMessage(msg.key.remoteJid, {
            text: `✳️ Usa el comando correctamente:\n\n📌 Ejemplo: *${global.prefix}play2doc* La Factoría - Perdoname`
        }, { quoted: msg });
        break;
    }
...
📥 *Opciones:*  
┣ 🎵 _${global.prefix}play1 ${text}_
┣ 🎥 _${global.prefix}play6 ${text}_
┗ ⚠️ *¿No se reproduce?* Usa _${global.prefix}ff_
...
case 'playdoc': {
    ...
    if (!text) {
        await sock.sendMessage(msg.key.remoteJid, {
            text: `✳️ Usa el comando correctamente:\n\n📌 Ejemplo: *${global.prefix}playdoc* bad bunny diles`
        }, { quoted: msg });
        break;
    }
...
case 'ytmp4doc': {
    ...
    if (!text || (!text.includes('youtube.com') && !text.includes('youtu.be'))) {
        await sock.sendMessage(msg.key.remoteJid, {
            text: `✳️ Usa el comando correctamente:\n\n📌 Ejemplo: *${global.prefix}ytmp4doc* https://youtube.com/watch?v=...`
        }, { quoted: msg });
        break;
    }
...
case 'ytmp3doc': {
  ...
  if (!text || !isYoutubeUrl) {
    await sock.sendMessage(msg.key.remoteJid, {
      text: `✳️ Usa el comando correctamente:\n\n📌 Ejemplo: *${global.prefix}ytmp3doc* https://music.youtube.com/watch?v=abc123`
    }, { quoted: msg });
    break;
  }
